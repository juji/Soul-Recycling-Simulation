...
type OutgoingMessage = SoulUpdatedMessage | ConnectionsUpdatedMessage | SoulRemovedMessage;
...
function shouldUpdatePhysicsForSoul(soul: WorkerSoulData, lodData: Record<number, LODData>, frameCount: number): boolean {
