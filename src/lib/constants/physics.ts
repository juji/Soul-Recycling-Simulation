...
export function validatePhysicsConstants(constants: Partial<PhysicsConstants>): PhysicsConstants {
  return {
    INTERACTION_DISTANCE: Math.max(
      1,
      Math.min(20, constants.INTERACTION_DISTANCE ?? PHYSICS_CONSTANTS.INTERACTION_DISTANCE)
    ),
    POINTER_INTERACTION_RADIUS: Math.max(
      1,
      Math.min(
        50,
        constants.POINTER_INTERACTION_RADIUS ?? PHYSICS_CONSTANTS.POINTER_INTERACTION_RADIUS
      )
    ),
    POINTER_INFLUENCE_STRENGTH: Math.max(
      0,
      Math.min(
        1,
        constants.POINTER_INFLUENCE_STRENGTH ?? PHYSICS_CONSTANTS.POINTER_INFLUENCE_STRENGTH
      )
    ),
    NEIGHBOR_SPEED_INFLUENCE_RADIUS: Math.max(
      1,
      Math.min(
        20,
        constants.NEIGHBOR_SPEED_INFLUENCE_RADIUS ??
          PHYSICS_CONSTANTS.NEIGHBOR_SPEED_INFLUENCE_RADIUS
      )
    ),
    NEIGHBOR_SPEED_INFLUENCE_STRENGTH: Math.max(
      0,
      Math.min(
        1,
        constants.NEIGHBOR_SPEED_INFLUENCE_STRENGTH ??
          PHYSICS_CONSTANTS.NEIGHBOR_SPEED_INFLUENCE_STRENGTH
      )
    ),
    SEPARATION_DISTANCE: Math.max(
      0.1,
      Math.min(10, constants.SEPARATION_DISTANCE ?? PHYSICS_CONSTANTS.SEPARATION_DISTANCE)
    ),
    SEPARATION_STRENGTH: Math.max(
      0,
      Math.min(1, constants.SEPARATION_STRENGTH ?? PHYSICS_CONSTANTS.SEPARATION_STRENGTH)
    ),
    DEWA_ATTRACTION_RADIUS: Math.max(
      1,
      Math.min(50, constants.DEWA_ATTRACTION_RADIUS ?? PHYSICS_CONSTANTS.DEWA_ATTRACTION_RADIUS)
    ),
    DEWA_ATTRACTION_STRENGTH: Math.max(
      0,
      Math.min(1, constants.DEWA_ATTRACTION_STRENGTH ?? PHYSICS_CONSTANTS.DEWA_ATTRACTION_STRENGTH)
    ),
    DEWA_ENHANCEMENT_RADIUS: Math.max(
      1,
      Math.min(30, constants.DEWA_ENHANCEMENT_RADIUS ?? PHYSICS_CONSTANTS.DEWA_ENHANCEMENT_RADIUS)
    ),
    ENHANCEMENT_SATURATION_BOOST: Math.max(
      0,
      Math.min(
        1,
        constants.ENHANCEMENT_SATURATION_BOOST ?? PHYSICS_CONSTANTS.ENHANCEMENT_SATURATION_BOOST
      )
    ),
    ENHANCEMENT_LIGHTNESS_BOOST: Math.max(
      0,
      Math.min(
        1,
        constants.ENHANCEMENT_LIGHTNESS_BOOST ?? PHYSICS_CONSTANTS.ENHANCEMENT_LIGHTNESS_BOOST
      )
    ),
  };
}
